...
Правила:
- Показывай все 5 категорий, даже если 0 — нулевые строки визуально
  подтверждают, что ты прошёл по таксономии полностью.
- В callout — только счётчики и короткая подпись категории.
