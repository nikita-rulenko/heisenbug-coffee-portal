...
- **Категории расхождений** (`rolled_back_fix`, `doc_drift`) — термин оставить можно, но хотя бы один раз в отчёте рядом дай короткое объяснение: «`rolled_back_fix` — прошлая сессия чинила, потом откатили».
